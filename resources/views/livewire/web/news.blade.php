    ...
    <div class="relative min-h-[80vh] py-16 overflow-hidden bg-white">
        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div class="mx-auto text-lg max-w-prose">
                ...
                <p class="max-w-md mx-auto mt-8 text-xl leading-8 text-gray-500">
                    Dapatkan berita, tips, dan cerita terbaru tentang produk, layanan, dan perusahaan favorit anda.
                </p>
            </div>

        ...
        <div class="swiper-wrapper">
            ...
            @foreach ($sliders as $slider)
                <div class="swiper-slide relative overflow-hidden">
                    <img class="object-cover bg-gray-100 rounded-xl lg:object-cover w-full h-[20rem] lg:h-[40rem] "
                    ...
                    <div class="hidden lg:block absolute inset-0 z-10">
                        <div class="w-full h-full pl-24 lg:pl-24 2xl:pl-[10rem]">
                            <div class="h-full flex flex-col lg:pl-10 2x:pl-0 2xl:max-w-4xl justify-center items-start">

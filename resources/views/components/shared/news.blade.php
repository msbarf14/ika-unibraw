                ...
                <article class="flex flex-col items-start justify-between">
                    ...
                    <div class="max-w-xl">
                        ...
                        <div class="group relative">
                            ...
                            <p class="mt-5 line-clamp-3 text-lg leading-6 text-gray-600">Illo sint voluptas. Error
                    ...
                    <article class="relative isolate flex flex-col gap-8 md:flex-row">
                        ...
                        <div class="w-full">
                            ...
                            <div class="group relative max-w-xl">
                                ...
                                <p class="mt-5 text-lg leading-6 line-clamp-3 text-gray-600">Illo sint voluptas. Error voluptates
                                    culpa
